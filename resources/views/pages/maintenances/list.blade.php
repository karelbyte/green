                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-8 col-sm-12">
                            ...
                            <div class="row m-t-10">
                                <div class="col-lg-12 col-xs-12">
                                    Frecuencia: <span class="txtblack">@{{entity.timer}}</span>
                                </div>
                            </div>
                            <div class="row m-t-10">
                                <div class="col-lg-12 col-xs-12">
    ...
    <div class="panel panel-border panel-inverse m-t-5">
        ...
        <table class="table table-hover">
            ...
            <tr class="mouse" v-for="detail in details" :key="detail.id">
                ...
                <td>
                    <button v-if="detail.status_id < 3" class="btn btn-primary  waves-effect btn-sm" @click="editDetail(detail)"><i class="fa fa-check-square"></i></button>
