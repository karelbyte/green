(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["/js/app/inventoris"],{
...
new Vue({
  ...
  methods: {
    ...
    viewpdf: function viewpdf() {
      ...
      this.spin = true;
      axios.get(urldomine + 'api/inventoris/pdf/' + this.filters_list.type.id).then(function (response) {
        _this2.spin = false;
...
/***/ 9:
/*!******************************************!*\
  !*** multi ./resources/js/inventoris.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/green/resources/js/inventoris.js */"./resources/js/inventoris.js");
