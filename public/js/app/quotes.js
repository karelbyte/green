(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["/js/app/quotes"],{
...
window.Quill = vue_quill_editor__WEBPACK_IMPORTED_MODULE_4__["Quill"];

var ImageResize = __webpack_require__(/*! quill-image-resize-module */ "./node_modules/quill-image-resize-module/image-resize.min.js");

vue_quill_editor__WEBPACK_IMPORTED_MODULE_4__["Quill"].register('modules/ImageResize', ImageResize);
...
new Vue({
  ...
  components: {
    Multiselect: vue_multiselect__WEBPACK_IMPORTED_MODULE_5___default.a //, 'QuillEditor' : VueQuill
    ...
    'detail.type_item': function detailType_item() {
      ...
      if (!this.editItem) {
        if (this.detail.type_item === 1) {
          ...
          this.detail.item = '';
          axios.get(urldomine + 'api/materials/products').then(function (res) {
            _this2.elements = res.data;
          });
        }
        ...
        if (this.detail.type_item === 2) {
          ...
          this.detail.item = '';
          axios.get(urldomine + 'api/productsoffereds/products').then(function (res) {
            _this2.elements = res.data;
          });
        }
        ...
        if (this.detail.type_item === 3) {
          ...
          this.detail.item = '';
          axios.get(urldomine + 'api/servicesoffereds/services').then(function (res) {
            _this2.elements = res.data;
          });
        }
  ...
  methods: {
    ...
    closeCreation: function closeCreation() {
      this.inCreation = false;
    },
    showHeadEdit: function showHeadEdit(head) {
      this.head = head;
      this.editQuote = true;
      this.inCreation = true;
    },
    ...
    showFormDet: function showFormDet() {
    ...
    saveNewDet: function saveNewDet() {
      ...
      if (this.detail.id !== 0) {
        ...
        this.head.details.push(_objectSpread({}, this.detail));
      } else {
    ...
    getIva: function getIva() {
      return (this.head.details.reduce(function (a, b) {
        return a + parseFloat(b.price) * parseFloat(b.cant);
      }, 0) * 0.16).toFixed(2);
    },
    // ENVIO DE INFO
...
/***/ 16:
/*!**************************************!*\
  !*** multi ./resources/js/quotes.js ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/html/green/resources/js/quotes.js */"./resources/js/quotes.js");
